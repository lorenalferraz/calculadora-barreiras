...
$cachePaths = @(
    "..\..\..\node_modules\.cache",
    "..\..\..\dist\widgets\filtrar-e-gerar-relatorio-main\filtrar-e-gerar-relatorio-barreiras"
)
...
$sourcePath = "..\..\..\dist\widgets\filtrar-e-gerar-relatorio-main\filtrar-e-gerar-relatorio-barreiras"
$destPath = "dist"
...
Write-Host "2. No Portal, remova o widget antigo e adicione novamente" -ForegroundColor White
Write-Host "   - Use o ZIP gerado pelo script package-widget.ps1, ou" -ForegroundColor Cyan
Write-Host "   - Faça upload via repositório Git se estiver usando essa opção" -ForegroundColor Cyan
