...
O Portal do Experience Builder **NÃO** consegue baixar todos os arquivos usando apenas uma URL raw de um arquivo específico.

Isso acontece porque:
- Uma URL raw retorna apenas o conteúdo de um arquivo específico
...
2. **Informe os dados do repositório:**
   - **URL do Repositório:** (informe a URL do seu repositório Git)
   - **Branch:** `main` (ou o branch principal do seu repositório)
...
- Teste se consegue acessar a URL do seu repositório Git
- Verifique se as credenciais estão configuradas corretamente no Portal

### Verificar se tudo está no repositório:

Acesse seu repositório Git e verifique que os seguintes arquivos estão presentes:
- ✅ manifest.json
- ✅ config.json
- ✅ icon.svg
- ✅ pasta dist/
...
2. **Todos os arquivos devem estar commitados** no branch principal
